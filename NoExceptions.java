...

{
    ...
    private static final Logger logger = Logger.getLogger(NoExceptions.class.getName());
    ...
    public static void main() {
        ...
        try {
                ...
                if (data.length == 0) {
                    logger.log(java.util.logging.Level.INFO, "No numeric data found in file: {0}", fileName);
                } else {
                    double sum = 0.0;
                    double min = data[0];
                    double max = data[0];
